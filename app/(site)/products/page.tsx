...
import { X, Ghost, Trash2, Upload,FileText, Trash } from "lucide-react";
          ...
          <TableBody>
            ...
            {documents.map((doc, index) => (
              <TableRow key={index}>
                ...
                <TableCell className="font-medium cursor-pointer">
                  <Link href={`/conversations/${doc.id}`}>{doc.title!}</Link>
                </TableCell>
                <TableCell className="font-medium cursor-pointer">
                  {doc.files.length}
                </TableCell>
                ...
                <TableCell className="font-medium cursor-pointer">
                  <Trash2 className="justify-self-center text-right text-red-500"/>
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
